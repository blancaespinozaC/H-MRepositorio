...
Araceli Garcia Diaz
07/05/2024
Extraccion de datos productos areas: bebes
"""
import time
import pandas as pd
...
def extraer_datos_producto():
    ...
    CateCli = navegador.find_element(By.CSS_SELECTOR, "a[href='/es_mx/bebe.html']")
    CateCli.click()
    time.sleep(3)
    ...
    df["Categoría"] = "Bebé"
    df.to_csv("DataSet/productosBebe.csv", index=False)
